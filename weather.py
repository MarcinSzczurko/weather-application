...
def display_weather_info(weather_data, fahrenheit=False):
    ...
    print(f"({temperature}°{'F' if fahrenheit else 'C'})")
...
if __name__ == "__main__":
    ...
    display_weather_info(weather_data, user_args.fahrenheit)
